...
class Settings(BaseSettings):
    ...
    smtp_host: Optional[str] = Field(default=None, env="APP_SMTP_HOST")
    smtp_port: Optional[int] = Field(default=None, env="APP_SMTP_PORT")
    smtp_username: Optional[str] = Field(default=None, env="APP_SMTP_USERNAME")
    smtp_password: Optional[str] = Field(default=None, env="APP_SMTP_PASSWORD")
    smtp_from: Optional[str] = Field(default=None, env="APP_SMTP_FROM")
